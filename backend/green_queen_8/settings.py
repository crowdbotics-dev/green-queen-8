"""
Django settings for green_queen_8 project.
...
ROOT_URLCONF = 'green_queen_8.urls'
...
WSGI_APPLICATION = 'green_queen_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_queen_8 API",
    "DESCRIPTION": "API documentation for green_queen_8 App",
    "VERSION": "v1",
}
